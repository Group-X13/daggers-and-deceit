        ...
        <div className="bg-card/30 backdrop-blur-sm rounded-lg p-6 space-y-6 text-lg">
          <section>
            ...
            <p className="text-white/90">
              Deceit & Daggers is a social deduction game where players must use their wit and intuition to identify the killer among them.
            </p>
          </section>
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-2 text-white/90">
              ...
              <li>Players participate in mini-games while the killer plans their moves</li>
              <li>When a player dies, everyone discusses and votes on the killer's identity</li>
              <li>The game continues until the killer is caught or all innocents are eliminated</li>
            </ol>
          </section>
        </div>
